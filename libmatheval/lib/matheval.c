 ...
 * Copyright (C) 2022 Picobat developpers
 *
 ...
 * only). */
_Thread_local char *input_string = NULL;	/* String representing function.  */
_Thread_local Node *root = NULL; /* Root of tree representation of function.  */
_Thread_local SymbolTable *symbol_table = NULL;	/* Evaluator symbol table.  */
_Thread_local int ok = 0; /* Flag determining if parsing went OK.  */
_Thread_local int floats = 0;
...
void           *
evaluator_create(char *string, int *pfloats, SymbolTable *symbols)
{
