...
extern          "C" {
    ...
    /* Evaluate function represented by evaluator given.
     * The variable values will be obtained through a call to
     * the given function.
     */

    extern double   evaluator_evaluate2(void *evaluator, double(*function)(const char*));
